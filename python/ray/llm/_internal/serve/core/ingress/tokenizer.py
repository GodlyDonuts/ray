...
class Tokenizer:
    ...
    def _build_tokenize_request(
        ...
        try:
            ...
            # add_generation_prompt / add_special_tokens must mirror the
            # generation path so these token IDs match the engine's prefill
            # tokens.
            ...
            if "prompt" in payload:
                ...
                if not isinstance(prompt, str):
                    # Multi-prompt (list) tokenization is unsupported; fall
